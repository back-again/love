...
import {
  useRelationshipProfileStore,
  RelationshipProfile,
} from '../_state/useRelationshipProfileStore';
...
const QUIZ_QUESTIONS: QuizQuestion[] = [
  {
    id: 1,
    question: '1. 바쁜 하루 중 연인의 연락 텀이 4시간 이상 길어질 때 나의 심리 상태는?',
    options: [
      {
  ...
  {
    id: 2,
    question: '2. 서운함이나 오해가 생겼을 때 내가 선호하는 갈등 해결 타이밍은?',
    options: [
      {
  ...
  {
    id: 3,
    question: '3. ⚠️ 이것만은 절대 타협 불가! 연인 관계에서 가장 감당하기 힘든 행동은?',
    options: [
      {
      ...
      {
        text: '갈등이 생겼을 때 대화를 피하고 회피하거나 잠수타는 태도.',
  ...
  {
    id: 4,
    question: '4. 내가 연인에게서 "사랑받고 있다"고 가장 강하게 느끼는 순간은?',
    options: [
      {
        text: '"오늘 고생했어" 따뜻한 한마디와 진심 어린 정서적 공감의 대화를 나눌 때.',
        trait: 'words',
      },
      {
        text: '바쁜 와중에도 나를 우선으로 챙겨주거나 현실적인 행동을 보여줄 때.',
        trait: 'actions',
      },
    ],
  },
  {
    id: 5,
    question: '5. 나에게 가장 기분 좋은 주말 데이트 및 에너지 충전 방식은?',
    options: [
      {
        text: '단둘이 조용하고 아늑한 공간에서 깊은 속마음을 나누는 데이트.',
        trait: 'cozy',
      },
      {
        text: '맛집, 여행, 새로운 장소를 탐방하며 활기찬 에너지를 주고받는 데이트.',
        trait: 'active',
      },
    ],
  },
  {
    id: 6,
    question: '6. 상대방의 특정 행동으로 마음이 상했을 때 나의 표현 방식은?',
    options: [
      {
        text: '표정이나 행동으로 서운함이 묻어나서 상대가 먼저 눈치채주길 바란다.',
        trait: 'subtle',
      },
      {
        text: '"나 이런 부분이 서운해"라고 감정과 원인을 명확하게 전달한다.',
        trait: 'direct_msg',
      },
    ],
  },
  ...
  {
    id: 10,
    question: '10. 이 연애를 계속 유지할지 심각하게 재고하게 만드는 가장 결정적인 순간은?',
    options: [
      {
...
const ALL_TEN_PROFILES: RelationshipProfile[] = [
  // 01. 말랑말랑 리트리버 인형
  {
    ...
    matchPartnerHeadline: '스스로 관계를 돌아보고 감정을 다룰 줄 아는 성숙한 상대',
    matchPartnerSub: '내가 혼자 관계를 이끌지 않아도 편안히 소통되는 사람',
    vulnerabilityHeadline: '책임감이 강해 상대의 문제나 몫까지 혼자 해결하려 해요',
    vulnerabilitySub: '혼자 짐을 안고 가다가 지칠 수 있어요',
    avoidPartners: [
      { tag: '', desc: '갈등을 대화로 풀지 않고 미루며 반복적으로 잠수타는 경우' },
      { tag: '', desc: '문제 해결을 위한 대화 후에도 개선 의지가 없는 경우' },
      { tag: '', desc: '신뢰를 깨뜨리는 작은 거짓말이나 속임을 습관적으로 하는 경우' },
    ],
    stats: [
  ...
  // 02. 폭신폭신 수면베개
  {
    ...
    matchPartnerHeadline: '받은 사랑을 당연하게 여기지 않고 다정하게 표현해 주는 상대',
    matchPartnerSub: '내 따뜻한 배려를 고맙게 느끼고 알아봐주는 사람',
    vulnerabilityHeadline: '상대에게 너무 맞추다 보니 정작 내 본래 감정을 눌러 담아요',
    vulnerabilitySub: '속으로 상처가 깊어져 뒤늦게 지칠 수 있어요',
    avoidPartners: [
      { tag: '', desc: '내 헌신과 배려를 이용하거나 당연하게 받아들이는 경우' },
      { tag: '', desc: '애정 표현이나 반응이 아예 사라져 무심함이 지속될 때' },
    ],
    stats: [
  ...
  // 03. 착착 스위스 아미 칼
  {
    ...
    matchPartnerHeadline: '감정 기복이 적고 논리적이고 깔끔한 대화가 통하는 상대',
    matchPartnerSub: '어른스럽고 깔끔한 소통 방식을 지닌 연인',
    vulnerabilityHeadline: '상대의 서운한 감정을 논리나 효율로만 다루려 해 상처를 줘요',
    vulnerabilitySub: '공감 표현이 부족해 차갑게 느껴질 수 있어요',
    avoidPartners: [
      { tag: '', desc: '문제 해결 의지 없이 무작정 감정적으로 떼쓰는 경우' },
      { tag: '', desc: '함께 정한 최소한의 규칙을 반복해서 어기는 경우' },
    ],
    stats: [
  ...
  // 04. 단단한 압력밥솥
  {
    ...
    matchPartnerHeadline: '먼저 편안하게 내 솔직한 속마음을 꺼낼 수 있도록 잘 끌어주는 상대',
    matchPartnerSub: '부담 주지 않고 다정히 기다려주는 사람',
    vulnerabilityHeadline: '속으로 서운함을 쌓아두다 한 번에 마음을 닫아버릴 수 있어요',
    vulnerabilitySub: '표현하지 않은 서운함이 묵혀질 위험이 있음',
    avoidPartners: [
      { tag: '', desc: '지속적인 강요나 압박으로 내 자유와 평화가 계속 위협받을 때' },
      { tag: '', desc: '내 말을 듣지 않고 본인 방식대로만 관계를 끌고 가려 할 때' },
    ],
    stats: [
  ...
  // 05. 톡 쏘는 탄산음료 캔
  {
    ...
    conflictHeadline: '앙금이 남지 않도록 그 자리에서 솔직하고 화끈하게 풀어버려요',
    conflictSub: '답답한 미룸 없이 즉각 직면하는 타입',
    matchPartnerHeadline: '돌려 말하지 않고 똑같이 직설적이며 감정을 담아두지 않는 상대',
    matchPartnerSub: '화끈하고 솔직하게 뒤끝 없는 연인',
    vulnerabilityHeadline: '직설적인 표현 때문에 다툴 때 상대에게 의도치 않은 상처를 줘요',
    vulnerabilitySub: '감정이 과열되면 어조가 거칠어질 수 있음',
    avoidPartners: [
      { tag: '', desc: '문제 앞에서 대화를 거부하거나 피하고 잠수타는 경우' },
      { tag: '', desc: '솔직하지 못하고 거짓말로 상황을 둘러대려 할 때' },
    ],
    stats: [
      { label: '표현 솔직도', level: 5 },
      { label: '애정 집착도', level: 4 },
  ...
  // 06. 잠금장치 다이어리
  {
    ...
    conflictHeadline: '혼자 생각할 시간을 가진 뒤 정리된 생각과 대안을 전달해요',
    conflictSub: '감정 폭발보다 냉정한 정리를 거치는 편',
    matchPartnerHeadline: '감정적으로 들볶지 않고 혼자만의 시간을 존중해 주는 담백한 상대',
    matchPartnerSub: '집착 없이 내 여유를 존중해주는 연인',
    vulnerabilityHeadline: '생각을 정리하는 동안 상대가 회피나 거절로 오해할 수 있어요',
    vulnerabilitySub: '소통 공백기에 상대의 불안을 살필 필요가 있음',
    avoidPartners: [
      { tag: '', desc: '개인적인 공간과 시간을 지속적으로 침해하거나 집착할 때' },
  ...
  // 07. 바스락 쿠쿠다스 과자
  {
    ...
    matchPartnerHeadline: '세심하게 상태를 물어봐 주고 정서적 안정감을 지속해서 제공하는 상대',
    matchPartnerSub: '확신과 다정함을 아낌없이 건네는 사람',
    vulnerabilityHeadline: '연인의 작은 표정이나 말투 변화에도 과도하게 민감해져요',
    vulnerabilitySub: '작은 변화도 불안으로 크게 해석할 수 있음',
    avoidPartners: [
      { tag: '', desc: '내 감정과 서운함에 대해 예민하다고 무시하거나 폄하할 때' },
  ...
  // 08. 반짝이는 도자기 선인장
  {
    ...
    matchPartnerHeadline: '자존감이 높고 각자의 일상과 라이프스타일이 독립적인 상대',
    matchPartnerSub: '서로의 성장을 쿨하게 응원해주는 사람',
    vulnerabilityHeadline: '관계에 대한 의지나 노력이 상대적으로 적어 보일 수 있어요',
    vulnerabilitySub: '상대가 무관심하다고 느낄 위험이 있음',
    avoidPartners: [
      { tag: '', desc: '내 생활 방식을 인정하지 않고 상대의 틀에 맞추라고 강요할 때' },
  ...
  // 09. 동글동글 몽돌 돌멩이
  {
    ...
    matchPartnerHeadline: '표현이 적은 내 마음을 깊이 있게 인지해 주고 고마워해 주는 상대',
    matchPartnerSub: '은은한 진심을 알아채주는 따뜻한 사람',
    vulnerabilityHeadline: '문제를 해결하기보다 그저 품어주기만 해서 오해가 길어져요',
    vulnerabilitySub: '솔직한 자기표현이 더 필요한 유형',
    avoidPartners: [
      { tag: '', desc: '내 묵묵한 이해와 포용을 약점 삼아 지속적으로 서운하게 할 때' },
  ...
  // 10. 쫀득쫀득 딱풀
  {
    ...
    conflictHeadline: '대화로 원인을 풀기보다 나를 얼마나 사랑하는지 확신받고 싶어 해요',
    conflictSub: '사랑의 크기와 연결감을 최우선으로 확인하는 편',
    matchPartnerHeadline: '끊임없이 사랑을 표현해 주고 정서적 울타리가 되어주는 다정한 상대',
    matchPartnerSub: '항상 편안하고 확실한 애정을 보여주는 사람',
    vulnerabilityHeadline: '불안감이 커지면 상대방을 시험하려 하거나 집착하게 돼요',
...
export function RelationshipQuizModal({
  visible,
  onClose,
}: RelationshipQuizModalProps) {
  ...
  const handleSelectOption = (trait: string) => {
    ...
    if (currentStep < QUIZ_QUESTIONS.length - 1) {
      ...
      // Q1 (index 0)
      if (updatedAnswers[0] === 'attached') userAttachment += 2;
      if (updatedAnswers[0] === 'independent') userHonesty += 1;

      // Q2 (index 1)
      if (updatedAnswers[1] === 'expressive') userHonesty += 2;
      if (updatedAnswers[1] === 'reflective') userResolution += 2;

      // Q3 (index 2)
      if (updatedAnswers[2] === 'honesty_dealbreaker') userHonesty += 1;
      if (updatedAnswers[2] === 'avoidance_dealbreaker') userResolution += 1;

      // Q4 (index 3)
      if (updatedAnswers[3] === 'words') userEmpathy += 2;
      if (updatedAnswers[3] === 'actions') userResolution += 1;

      // Q5 (index 4)
      if (updatedAnswers[4] === 'cozy') userEmpathy += 1;
      if (updatedAnswers[4] === 'active') userHonesty += 1;

      // Q6 (index 5)
      if (updatedAnswers[5] === 'direct_msg') userHonesty += 2;
      if (updatedAnswers[5] === 'subtle') userEmpathy += 1;

      // Q7 (index 6)
      if (updatedAnswers[6] === 'strict_boundary') userAttachment += 2;
      if (updatedAnswers[6] === 'flexible_boundary') userEmpathy += 1;

      // Q8 (index 7)
      if (updatedAnswers[7] === 'sanctuary') userEmpathy += 2;
      if (updatedAnswers[7] === 'synergy') userResolution += 1;

      // Q9 (index 8)
      if (updatedAnswers[8] === 'ask_reassurance') userAttachment += 2;
      if (updatedAnswers[8] === 'self_soothe') userResolution += 1;

      // Q10 (index 9)
      if (updatedAnswers[9] === 'no_effort') userResolution += 1;
      if (updatedAnswers[9] === 'disrespect') userEmpathy += 1;
      ...
      const resultProfile = ALL_TEN_PROFILES[selectedIndex];
