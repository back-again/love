...
const STORIES = [
  ...
  },
  {
    ...
    biasX: 0.60,
    review_content: `많은 분들이 무조건 미련이니까 먼저 흔들어 보거나 스토리로 저격해보라고 조언해주셔서, 용기 내서 전남친이 염탐하는 부계정으로 다이렉트 메시지(DM)를 보냈어요! \n\n'누구누구 맞지? 강아지 프사 보니까 바로 알겠더라. 매일 스토리 보러 오던데 무슨 일 있어?'라고 선톡을 보냈거든요. 그랬더니 한 2시간 뒤에 답장이 왔는데... \n\n'아... 들켰네 미안해. 사실 헤어지고 나서 네가 너무 잘 살고 있는 거 같아서 질투도 나고, 혹시 다른 사람 생겼나 궁금해서 계속 훔쳐봤어. 먼저 연락할 용기는 안 났는데 이렇게 연락 줘서 고마워' 하면서 엄청 미안해하더라고요 ㅠㅠ \n\n그날 저녁에 전화로 한 시간 넘게 얘기하면서 서로 서운했던 거 다 풀고, 이번 주말에 만나서 밥 한끼 먹으면서 천천히 다시 얘기해보기로 했습니다! 다들 미련 100%라고 댓글 달아주신 집단지성 덕분에 용기 낼 수 있었어요. 정말 감사합니다! 💖`,
    commentsO: [
  ...
  for (const story of STORIES) {
    ...
    const { data: post, error: postErr } = await supabase
      ...
      .insert({
        ...
        vote_o: story.vote_o,
        vote_x: story.vote_x,
        review_content: story.review_content || null,
