...
const STORIES = [
  ...
  },
  {
    ...
    vote_o: '미련 있음, 선톡한다',
    vote_x: '호기심일 뿐, 차단함',
    review_content: `댓글 보고 걍 차단할까 하다가 새벽에 술김에 '왜 자꾸 염탐하냐'고 카톡 선톡 보냈음.\n\n전남친 처음에 모르는 척 잡아떼고 부계정 뭔지 모른다 하다가, 결국 미련 남아서 계속 훔쳐본 거 맞다고 인정함 ㅋㅋㅋ\n\n근데 대화하다 보니까 바뀐 거 하나도 없고 여전히 찌질하게 핑계만 대길래 정뚝떨이라 카톡 인스타 다 차단 박음.\n\n진짜 탈출은 지능순인 듯. 역시 사람은 고쳐 쓰는 거 아니다 다들 조언 고마워!`,
    commentsO: [
