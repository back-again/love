...
VALUES 
  ...
  (
    ...
    '장거리면 연락이 생명, 남친이 맞춰야 함',
    '일하고 피곤한 남친 입장도 배려해야 함',
    NULL,
  ...
  (
    ...
    '실제로 만나진 않았다니 한 번은 눈감아준다',
    '어플 결제까지 한 건 이미 선 넘은 바람, 파혼이다',
    NULL,
  ...
  (
    ...
    '10년 지기 친구가 힘들면 연락할 수 있지, 예민함',
    '새벽에 남의 남친한테 울며 전화하는 건 선 넘었음, 무조건 화날 일',
    NULL,
